...
parser.add_argument("--image_height", help="Height of the model input images", default=300, type=int )
parser.add_argument("--image_width", help="width of the model input images", default=300, type=int )
...
train_dataset = DataGenerator(load_images_into_memory=False, hdf5_dataset_path='hdf5/dataset_fire_train.h5')
val_dataset = DataGenerator(load_images_into_memory=False, hdf5_dataset_path='hdf5/dataset_fire_test.h5')
...
#train_dataset.create_hdf5_dataset(file_path='hdf5/dataset_fire_train.h5',
#                                  resize=False,
#                                  variable_image_size=True,
#                                  verbose=True)
#
#val_dataset.create_hdf5_dataset(file_path='hdf5/dataset_fire_test.h5',
#                                resize=False,
#                                variable_image_size=True,
#                                verbose=True)
...
model_checkpoint = ModelCheckpoint(filepath=os.path.join(args.checkpoint_path,'ssd300_fire_{}_{}.h5'.format(current_time[0],current_time[1])),
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
csv_logger = CSVLogger(filename=os.path.join(args.log_path,'ssd300_fire_{}_{}.csv'.format(current_time[0],current_time[1])),
                       separator=',',
                       append=True)
...
tensorboard=TensorBoard(log_dir=os.path.join(args.tensorboard_path,'ssd300',current_time[0],current_time[1]), write_images=True, write_graph=True)
